...
class PHPWebSocket
{
	...
	*/
	...
	function wsSendstart($clientID) {
		if ( array_key_exists('start', $this->wsOnEvents) )
			foreach ( $this->wsOnEvents['start'] as $func )
				$func($clientID);
			print_r(array_key_exists('start', $this->wsOnEvents));
	}
